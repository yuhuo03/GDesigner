...
from datasets.multiarith_dataset import load_multiarith, multiarith_data_process, multiarith_get_predict
...
async def main():
    ...
    # Load dataset
    raw_data = load_multiarith(args.dataset_json)
    dataset = multiarith_data_process(raw_data)
    if args.limit_questions:
        dataset = dataset[:args.limit_questions]
    print(f"[MultiArith] Total questions: {len(dataset)}")
    ...
    for i_batch in range(num_batches):
        ...
        for idx, (realized_graph, record) in enumerate(batch_records):
            ...
            predict_answer = multiarith_get_predict(answer)
