...
def parse_args():
    parser = argparse.ArgumentParser(description="Run one AQuA baseline method.")
...
async def main():
    ...
    result_dir = Path(args.result_dir) if args.result_dir else Path(GDesigner_ROOT / "result" / "aqua")
    ...
    download(data_dir=args.data_dir, required_splits=("test",))
